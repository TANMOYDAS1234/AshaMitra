...
const S=' Warm photorealistic documentary photograph, soft natural light, shallow depth of field, dignified hopeful caring mood. Soft plum-and-cream tones matching a maternal-health app (purple #791C87 / magenta #BD3773 accents). Wide landscape 16:9 composition with the subject slightly right so the lower-left stays calm for an overlaid caption. No text, no logo, no watermark.';
const ITEMS=[
 ['anc.png','A serene smiling pregnant Indian woman in a soft lavender-and-cream saree, both hands gently cradling her round belly, in a bright clean home.'+S],
 ['pnc.png','A tender young Indian mother in a soft saree lovingly holding her newborn wrapped in white muslin against her chest, gazing down.'+S],
