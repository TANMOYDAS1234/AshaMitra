...
| `NB-COMB-004` (combination) | RED | "Is the navel red, swollen, or has pus?" = Yes AND "Does the baby have fever?" = Yes | Umbilical infection + fever = systemic sepsis risk (PSBI). Keep the baby warm, keep breastfeeding, call 108 and take to SNCU/FRU now, and inform the ANM/MO. Do not give any medicine yourself. | [ ] | [ ] | [ ] |  |
| `NB-COMB-005` (combination) | RED | "Is the baby unable to breastfeed?" = Yes AND "Does the baby have fever?" = Yes | Not feeding + fever = possible serious infection (PSBI). Keep the baby warm, keep trying to breastfeed, call 108 and take to SNCU/FRU now, and inform the ANM/MO. Do not give any medicine or injection yourself. | [ ] | [ ] | [ ] |  |
...
| `CH-004` (RED hard-stop) | RED | "Is the child completely refusing to eat?" = Yes | Complete refusal to eat/feed = IMNCI general danger sign. Call 108 and take to FRU now. -> FRU / DH immediately | [ ] | [ ] | [ ] |  |
| `CH-013` (RED hard-stop) | RED | "Lower chest indrawing, or stridor at rest?" = Yes | Lower chest indrawing or stridor at rest = severe pneumonia / very severe disease. Keep the child calm, call 108 and take to FRU now. -> FRU / DH immediately | [ ] | [ ] | [ ] |  |
...
| `CH-COMB-003` (combination) | RED | "Is there diarrhoea or repeated vomiting?" = Yes AND "Is the child completely refusing to eat?" = Yes | Diarrhoea + refusal to eat = severe dehydration risk. If the child can swallow, give ORS by spoon; call 108 and refer to FRU now. | [ ] | [ ] | [ ] |  |
...
| `CH-VITAL-008` (measurement) | YELLOW | spo2 between [90-94] | SpO2 90–94% = moderate hypoxia. Keep the child calm and upright, refer to PHC promptly. | [ ] | [ ] | [ ] |  |
...
| `ANC-009R` (RED hard-stop) | RED | "Fever WITH chills or rigors?" = Yes | Fever with rigors in pregnancy = possible malaria or sepsis. Lay on left side, call 108 and take to FRU now. -> FRU / DH immediately by 108 | [ ] | [ ] | [ ] |  |
...
| `ANC-COMB-004` (combination) | RED | "Is blood pressure high?" = Yes AND "Is there blurred vision?" = Yes | High BP + blurred vision = severe pre-eclampsia. Lay on left side, call 108 and take to FRU now. | [ ] | [ ] | [ ] |  |
...
| `ANC-VITAL-005` (measurement) | RED | systolic_bp >= 160 | Systolic BP ≥ 160 mmHg — severe hypertension. Lay on left side, call 108 and take to FRU now. | [ ] | [ ] | [ ] |  |
...
| `ANC-VITAL-011` (measurement) | RED | tsh_miu > 10 | TSH > 10 mIU/L on report = thyroid problem. Refer to PHC/MO — do not start or change any medicine yourself. | [ ] | [ ] | [ ] |  |
| `ANC-VITAL-012` (measurement) | YELLOW | tsh_miu between [2.5-10] | TSH 2.5–10 mIU/L on report = mildly raised thyroid. Refer to PHC/MO; do not give medicine yourself. | [ ] | [ ] | [ ] |  |
| `ANC-VITAL-013` (measurement) | YELLOW | ogtt_2hr_mg_dl >= 140 | High sugar on report (GDM). Refer to PHC/MO for GDM management. ASHA role: counsel balanced diet and ensure follow-up. Do not give medicine or insulin yourself. | [ ] | [ ] | [ ] |  |
...
| Rule | Band | Fires when | Action / referral | Approve | Adjust | Reject | Note |
|---|---|---|---|:--:|:--:|:--:|---|
| `PNC-001` (RED hard-stop) | RED | "Is there excessive bleeding or foul-smelling discharge?" = Yes | PPH hard-stop. Do firm external fundal massage over the uterus, lay the mother down, call 108 and take to FRU/DH now. -> FRU / DH immediately | [ ] | [ ] | [ ] |  |
| `PNC-006S` (RED hard-stop) | RED | "Fainting / collapsing, or unable to stand (severe weakness)?" = Yes | Severe postpartum dizziness/collapse = possible concealed bleeding or shock. Lay flat with legs raised, call 108 and take to FRU now. -> FRU / DH via 108 now | [ ] | [ ] | [ ] |  |
...
| `PNC-VITAL-004` (measurement) | RED | systolic_bp >= 140 | Postpartum systolic BP ≥ 140 = postpartum pre-eclampsia. Lay on left side, call 108 and take to FRU now. | [ ] | [ ] | [ ] |  |
...
| `PNC-VITAL-008` (measurement) | RED | temperature_c >= 38.9 | Temp ≥ 38.9°C postpartum = severe puerperal sepsis. Keep the mother warm and hydrated, do not give medicine yourself, call 108 and take to FRU now. | [ ] | [ ] | [ ] |  |
...
Total draft rules awaiting sign-off: 63.
