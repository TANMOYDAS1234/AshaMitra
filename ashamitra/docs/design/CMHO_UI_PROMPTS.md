# CMHO Panel — Colour Identity & Stitch AI Prompts

> For what a CMHO actually DOES — her workflows and tasks — see `CMHO.md`.
> This file is purely the visual spec and the prompts for generating UI.
