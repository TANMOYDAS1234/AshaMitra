...
class SituationExtractor {
  static const _moduleMap = <String, List<_SymptomRule>>{
    ...
    'child': [
      ...
      _SymptomRule(triggers: [
        // Standard Bengali
        'ওজন কম', 'ওজন অনেক কম', 'ওজন খুব কম', 'অনেক কম ওজন', 'শুকিয়ে গেছে', 'রোগা', 'হাড় বের হয়ে গেছে', 'অপুষ্টি',
        // Rarhi
    ...
    'delivery_pnc': [
      ...
      _SymptomRule(triggers: [
        // Standard Bengali
        'স্তন ব্যথা', 'স্তনে ব্যথা', 'স্তন', 'বুকে ব্যথা', 'স্তন ফুলেছে', 'দুধ জমেছে', 'বুক ব্যথা',
        // Rarhi
      ...
      _SymptomRule(triggers: [
        // Standard Bengali
        'পেট ব্যথা', 'পেটে ব্যথা', 'পেটে তীব্র ব্যথা', 'তীব্র পেট ব্যথা',
        'পেটে অনেক ব্যথা', 'সেলাই', 'ক্ষত', 'সেলাইয়ে সমস্যা',
        // Rarhi
